...
`seedance-2.5`: billed `per_second` by resolution (`seedance-2.5-480p` / `seedance-2.5-720p`). Duration 4–30 s (default 4); aspect_ratio `16:9|9:16|1:1` (default `9:16`); resolution `480p|720p`; max 30 `--image` / 10 `--video` (each & total ≤30.2s, fps ≤60) / 10 `--audio` (each ≤30s). Docs: https://docs.viraltok.ai/zh/api-reference/seedance/25/create.md
